...
public class JsConfigController {
    ...
    public Map<String, Object>  getJSConfig(@RequestParam(value = "url", required = false) String url,
        ...
        try{
            ...
            url = check(url,corpId,suiteKey);
            ServiceResult<CorpJSAPITicketVO> jsapiTicketSr = corpManageService.getCorpJSAPITicket(suiteKey, corpId);
            ServiceResult<CorpAppVO> corpAppVOSr = corpManageService.getCorpApp(corpId);
            ...
            //System.out.println(JSON.toJSONString(jsapiConfig));
    ...
    private String check(String url,String corpId,String suiteKey) throws Exception{//TODO 妈蛋的就然没有定义serviceexception
        try {
